...
/**
 * [ip2area ip地址转换成地区城市]
 * by ayumi 2015 4.22 QQ:44784009
 * @param  [type] $ipaddress [description]
 *
 * @return [type]            [description]
 */
function ip2area($ipaddress){ 
 ...
 * @return 字符串 返回指定分类下的子分类 如：2,3,4
 */
function ayu_get_child_term_id($term_id){

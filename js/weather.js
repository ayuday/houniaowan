var weather=function(){
    ...
    this.getWeather=function(city,type){//根据city的值获取天气信息
		$.getScript("http://php.weather.sina.com.cn/iframe/index/w_cl.php?code=js&day=0&city="+city+"&dfc=3",function(){echo(city);});}
		
	function dis_img(weather){//显示不同天气对应的图片
		var route="/js/weather/";//文件夹路径
	...
	$('#T_temperature').html('<span class="green">'+window.SWther.w[city][0].t2+'℃</span>~<span class="red">'+window.SWther.w[city][0].t1+'℃</span>');
